...
import com.underwriteai.common.tenant.TenantContext
import com.underwriteai.common.web.NotFoundException
...
class AiToolRunService(private val repository: AiToolRunRepository) {
    ...
    fun record(
        ...
        val run = AiToolRun(tool = tool, status = status, requestHash = requestHash, resultRef = resultRef)
