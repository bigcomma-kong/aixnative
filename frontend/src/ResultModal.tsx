...
/** 사용 내역 → 분석 결과 모달. 도구(언더라이팅·문서·시장심층) 무관하게 결과 JSON 을 읽기 좋게 렌더. */
export function ResultModal({ run, result, onClose }: { run: RunSummary; result: any; onClose: () => void }) {
    ...
    <div className="analyze-overlay" role="dialog" aria-modal="true" aria-label="분석 결과" onClick={onClose}>
      <div className="result-modal" onClick={(e) => e.stopPropagation()}>
        <div className="rm-head">
          <div>
            <span className="rm-tool">{toolLabel(run.tool)}</span>
